# Prove that a consumer can restore the complete release from the packages about to
# be pushed, resolving every remaining dependency from nuget.org.
[CmdletBinding()]
param(
...
if ($LASTEXITCODE -ne 0) { throw "Consumer restore failed. Check feed access and publish missing dependencies first. Diagnostics: $scratch" }
